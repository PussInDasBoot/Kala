module ApplicationHelper
  ...
  def show_free_busy
    ...
    kala_calendar_id = "bdiuqssu2iudobsr579mtb3uu4@group.calendar.google.com"
    ...
    # free_busy_request_item.id = current_user_calendar_id
    ...
    # jackies_busy_times = free_busy_response.calendars[current_user_calendar_id].busy
    # jackies_busy_times.each do |busy_time|
    #   puts busy_time.start.to_date
    #   puts busy_time.end.to_date
    # end

    event = Google::Apis::CalendarV3::Event.new(
      summary: 'Test Event',
      location: 'Lighthouse Labs',
      description: 'A test event sent from Rails',
      start: {
        date_time: '2016-08-10T09:00:00-07:00',
        time_zone: 'America/Vancouver'
      },
      end: {
        date_time: '2016-08-10T10:00:00-07:00',
        time_zone: 'America/Vancouver'
      })

    # kala_calendar_id currently does not work
    response = service.insert_event(current_user_calendar_id, event)
    puts response
    # event = Google::Apis::CalendarV3::Event.new
